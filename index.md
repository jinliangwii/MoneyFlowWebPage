...
<div class="hero-section">
  <h1>MoneyFlow</h1>
  <p>A modern personal finance management app built with SwiftUI for macOS</p>
</div>
...
<div class="feature-grid">
  <div class="feature-card">
    <h3>Dashboard</h3>
    <p>Visualize your financial data with interactive charts including income and expense analysis, category breakdowns, and trend tracking.</p>
  </div>
  
  <div class="feature-card">
    <h3>Account Management</h3>
    <p>Track multiple bank accounts and financial institutions with an organized two-column layout for easy navigation.</p>
  </div>
...
<div class="future-plans">
  <h2>Coming Soon</h2>
  <p>We're constantly working to make MoneyFlow even better. Here's what's on the horizon:</p>
  ...
  <div class="plan-grid">
    ...
    <div class="plan-card">
      <h3>Transaction Analysis <span class="badge">Planned</span></h3>
